...
PRO run_n2vk_model, Ts, wl1, wl2, wl3, sp1, sp2, sp3
    ...
    ; For Oplus panel
    ;21 6
    convolve_sp, wl(wv_vk,21,5), int(int_vk,21,5), 0.6d, wl2, sp5_21
    ;20 4
    convolve_sp, wl(wv_vk,20,4), int(int_vk,20,4), 0.6d, wl2, sp4_20
    ;18 1
    convolve_sp, wl(wv_vk,18,1), int(int_vk,18,1), 0.6d, wl2, sp1_18

    sp2 = [[sp5_21], [sp4_20], [sp1_18]]

    ; For OH panel
    ;21 4
    convolve_sp, wl(wv_vk,21,4), int(int_vk,21,4), 0.6d, wl1, sp4_21
    ;20 3
    convolve_sp, wl(wv_vk,20,3), int(int_vk,20,3), 0.6d, wl1, sp3_20
    ;17 0
    convolve_sp, wl(wv_vk,17,0), int(int_vk,17,0), 0.6d, wl1, sp0_17
