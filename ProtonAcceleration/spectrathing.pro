...
for i = 0, 5 do begin
	...
	for j=0,leng-1 do begin
		read_tim, startimes[j], 10/60., mjs0, time, dseq, icount, /nophot
...
pro makeandsavespectra, fname, savename, spectrum

get_timings, fname, years, months, days, hours, mins, secs, msecs, lens
spectrathing, years, months, days, hours, mins, secs, msecs, lens, spectrum
